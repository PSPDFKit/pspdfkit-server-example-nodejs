...
Open the example at [http://localhost:8080](http://localhost:8080). You can access the Nutrient Document Engine dashboard at [http://localhost:5000/dashboard](http://localhost:5000/dashboard) using `dashboard` // `secret`.
