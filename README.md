# PSPDFKit Document Engine Example – Node.js
...
_Note: This example demonstrates the usage of PSPDFKit for Web in a Node.js application and is not optimized for production deployments. For information on how to set up PSPDFKit for Web in production, please refer to [our guides](https://pspdfkit.com/guides/document-engine/deployment/) instead._
...
Make sure to replace `YOUR_ACTIVATION_KEY_GOES_HERE` with your PSPDFKit Document Engine activation key. You only have to provide the activation key once, after that Document Engine will remain activated until you reset it.
...
- [PSPDFKit Document Engine](https://pspdfkit.com/guides/web/current/server-backed/setting-up-pspdfkit-server/)
