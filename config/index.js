...
module.exports = {
  ...
  //
  pspdfkitInternalUrl: process.env.PSPDFKIT_SERVER_INTERNAL_URL || "http://localhost:5000",
  pspdfkitExternalUrl: process.env.PSPDFKIT_SERVER_EXTERNAL_URL || "http://localhost:5000",
